...
export type AdminErrorCode =
  ...
  | "pack_publication_preview_not_found"
  | "pack_publication_state_changed"
  | "pack_publication_confirmation_invalid"
  | "pack_publication_blocked"
  | "pack_publication_in_progress"
  | "pack_maintenance_invalid"
  | "pack_membership_conflict"
  | "pack_maintenance_preview_not_found"
  | "pack_maintenance_blocked"
  | "pack_maintenance_failed"
  | "no_change"
  | "alias_conflict"
  | "alias_not_found"
  | "alias_preview_not_found"
  | "alias_change_failed"
  | "release_not_found"
